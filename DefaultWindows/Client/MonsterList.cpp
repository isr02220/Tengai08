...
stMonsterInfo MobList[] = {
	...
	{ MONSTER_TYPE_01,	1000,		(float)WINCX,		160.f,		ITEM_TYPE_NONE,	nullptr,			0,						mobMList0,		mobMList0Size }, // UFO부대 시작
	{ MONSTER_TYPE_01,	1100,		(float)WINCX,		240.f,		ITEM_TYPE_NONE,	nullptr,			0,						mobMList0,		mobMList0Size },
	{ MONSTER_TYPE_01,	1200,		(float)WINCX,		320.f,		ITEM_TYPE_NONE,	nullptr,			0,						mobMList0,		mobMList0Size },
	{ MONSTER_TYPE_02,	1300,		(float)WINCX,		400.f,		ITEM_TYPE_NONE,	nullptr,			0,						mobMList0,		mobMList0Size }, // UFO부대 끝

	{ MONSTER_TYPE_03,	2000,		1500.f,				0.f,		ITEM_TYPE_NONE,	mobBListHorming1,	mobBListHorming1Size,	mobMList1,		mobMList1Size },

	{ MONSTER_TYPE_04,	3000,		1600.f,				280.f,		ITEM_TYPE_NONE,	mobBListBoss1,		mobBListBoss1Size,		mobMListBoss1,	mobMListBoss1Size },
	...
	{ MONSTER_TYPE_05,	5917,		(float)WINCX,		180.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle185,		mobMListAngle185Size },
	...
	{ MONSTER_TYPE_05,	7000,		(float)WINCX,		185.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle175,		mobMListAngle175Size },
	{ MONSTER_TYPE_05,	7292,		(float)WINCX,		450.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle185,		mobMListAngle185Size },
	{ MONSTER_TYPE_05,	7292,		(float)WINCX,		750.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle190,		mobMListAngle190Size },
	{ MONSTER_TYPE_05,	7542,		(float)WINCX,		750.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle185,		mobMListAngle185Size },
	{ MONSTER_TYPE_05,	7542,		(float)WINCX,		770.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle190,		mobMListAngle190Size },
	{ MONSTER_TYPE_05,	7833,		(float)WINCX,		200.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle180,		mobMListAngle180Size },

	{ MONSTER_TYPE_01,	8000,		(float)WINCX,		160.f,		ITEM_TYPE_NONE,	nullptr,			0,						mobMList0,				mobMList0Size },

	{ MONSTER_TYPE_05,	8083,		(float)WINCX,		200.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle175,		mobMListAngle175Size },
	{ MONSTER_TYPE_05,	8083,		(float)WINCX,		700.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle185,		mobMListAngle185Size },

	{ MONSTER_TYPE_01,	8100,		(float)WINCX,		240.f,		ITEM_TYPE_NONE,	nullptr,			0,						mobMList0,				mobMList0Size },
	{ MONSTER_TYPE_01,	8200,		(float)WINCX,		320.f,		ITEM_TYPE_NONE,	nullptr,			0,						mobMList0,				mobMList0Size },
	{ MONSTER_TYPE_02,	8300,		(float)WINCX,		400.f,		ITEM_TYPE_NONE,	nullptr,			0,						mobMList0,				mobMList0Size },
	
	{ MONSTER_TYPE_05,	8417,		(float)WINCX,		300.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle180,		mobMListAngle180Size },
	{ MONSTER_TYPE_05,	8625,		(float)WINCX,		500.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle190,		mobMListAngle190Size },
	...
	{ MONSTER_TYPE_05,	12292,		(float)WINCX,		200.f,		ITEM_TYPE_NONE,	mobBList50,			mobBList50Size,			mobMListAngle180,		mobMListAngle180Size },
